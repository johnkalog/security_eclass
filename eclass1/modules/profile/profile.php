...
$username_form = htmlspecialchars($myrow['username'],ENT_QUOTES,'UTF-8'); //------
$password_form = $myrow['password'];
$email_form = htmlspecialchars($myrow['email'],ENT_QUOTES,'UTF-8'); //------
$am_form = htmlspecialchars($myrow['am'],ENT_QUOTES,'UTF-8'); //------
