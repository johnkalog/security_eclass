  ...
  <tr>
    ...
    while ($mycours = mysql_fetch_array($result)) {
        if ($mycours['visible'] == 2) {
            $codelink = "<a href='../../courses/$mycours[k]/'>".htmlspecialchars($mycours[i],ENT_QUOTES,'UTF-8')."</a>&nbsp;<small>(" . $mycours['c'] . ")</small>";
        } else {
            $codelink = htmlspecialchars($mycours[i],ENT_QUOTES,'UTF-8')."&nbsp;<small>(" . $mycours['c'] . ")</small>";
        }
