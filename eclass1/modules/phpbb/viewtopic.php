...
$forum_name = htmlspecialchars(own_stripslashes($myrow["forum_name"]),ENT_QUOTES,'UTF-8');
...
$topic_subject = htmlspecialchars(own_stripslashes($myrow["topic_title"]),ENT_QUOTES,'UTF-8');
...
do {
	...
	$tool_content .= "<tr>";
	$tool_content .= "<td class=\"$row_color\"><b>" . htmlspecialchars($myrow["prenom"],ENT_QUOTES,'UTF-8') . " " . htmlspecialchars($myrow["nom"],ENT_QUOTES,'UTF-8') . "</b></td>";
